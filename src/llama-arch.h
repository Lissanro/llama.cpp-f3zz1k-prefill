...
enum llm_tensor {
    ...
    LLM_TENSOR_OUTPUT_NORM_GATE_UP,
    LLM_TENSOR_OUTPUT_NORM_GATE_DOWN,
    ...
    LLM_TENSOR_ATTN_NORM_GATE_UP,
    LLM_TENSOR_ATTN_NORM_GATE_DOWN,
    LLM_TENSOR_ATTN_NORM_2,
    LLM_TENSOR_ATTN_OUT_NORM,
    LLM_TENSOR_ATTN_POST_NORM,
    LLM_TENSOR_ATTN_POST_NORM_GATE_UP,
    LLM_TENSOR_ATTN_POST_NORM_GATE_DOWN,
    ...
    LLM_TENSOR_FFN_NORM,
    LLM_TENSOR_FFN_NORM_GATE_UP,
    LLM_TENSOR_FFN_NORM_GATE_DOWN,
    LLM_TENSOR_FFN_POST_NORM,
    LLM_TENSOR_FFN_POST_NORM_GATE_UP,
    LLM_TENSOR_FFN_POST_NORM_GATE_DOWN,
    ...
    LLM_TENSOR_ATTN_Q_A_NORM_GATE_UP,
    LLM_TENSOR_ATTN_Q_A_NORM_GATE_DOWN,
    ...
    LLM_TENSOR_ATTN_KV_A_NORM_GATE_UP,
    LLM_TENSOR_ATTN_KV_A_NORM_GATE_DOWN,
    ...
    LLM_TENSOR_NEXTN_ENORM_GATE_UP,
    LLM_TENSOR_NEXTN_ENORM_GATE_DOWN,
    LLM_TENSOR_NEXTN_HNORM,
    LLM_TENSOR_NEXTN_HNORM_GATE_UP,
    LLM_TENSOR_NEXTN_HNORM_GATE_DOWN,
